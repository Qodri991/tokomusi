...
<section id="Banner">
                        ...
                        <div class="bg-banner">
                            <div class="row justify-content-center">
                                <div class="col-lg-5">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <a href="Detail-Product.html"><div class="btn btn-warning">Lihat Details</div></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-5">
        ...
        <section id="Product-Category">
            <div class="bg-category mt-5">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <a href=""><h1>Product <span>Category</span></h1></a>
                        </div>
                    </div>
        ...
        <section id="Category-Promo">
            <div class="container">
                <div class="row mt-5">
                    <div class="col">
                        <a href=""><h1>Category <span>Promo</span></h1></a>
                    </div>
                </div>
                <div class="row mt-4">
        ...
        <section id="Product-Terlaris">
            <div class="container">
                <div class="row mt-5">
                    <div class="col">
                       <a href=""><h1>Product <span>Terlaris</span></h1></a>
                    </div>
                </div>
                <div class="row mt-4 ">
        ...
        <section id="Flash-Deals">
            <div class="bg-FlashDeals">
                <div class="container">
                    <div class="row">
                        <div class="col mt-4">
                            <a href=""><h1>Flash <span>Deals</span></h1></a>
                        </div>
                    </div>
                    <div class="row text">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col text-center mb-3">
                                            <a href="Detail-Product.html"><div class="btn btn-warning">Lihat
                                                Details</div></a>
                                        </div>
                                    </div>
                                </div>
